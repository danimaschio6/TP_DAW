...
let RespuestasService = class RespuestasService {
    ...
    constructor(respuestasRepository) {
        this.respuestasRepository = respuestasRepository;
    }
    async crearRespuesta(dto) {
        const respuesta = this.respuestasRepository.create(dto);
...
exports.RespuestasService = RespuestasService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(respuesta_entity_1.Respuesta)),
